...
def cv_chat(user_input):
    ...
    conversation = [
            ...
            {"role": "assistant", "content": "Thankyou for providing information on your life and CV, if anyone asks anything not related to Kyll and his life I will respond with 'That is not relevant to Kyll's Applicantion'"},
            {"role": "user",
